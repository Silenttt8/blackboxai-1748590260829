...
<?php 
	...
	<div class="container">
		...
		<br/>
		<a href="transaksi.php" class="btn btn-primary pull-left">Kembali</a>
		<a href="transaksi_invoice_cetak.php?id=<?php echo $id; ?>" class="btn btn-primary pull-right"><i class="glyphicon glyphicon-print"></i> CETAK</a>
		<br/>
			...
			while($t=mysqli_fetch_array($transaksi)){
				...
				<table class="table">
					...
					<tr>
						<th>Status Pembayaran</th>
						<th>:</th>
						<td><strong>Belum Dibayar</strong> <a href="pembayaran.php?id=<?php echo $id_transaksi; ?>" class="btn btn-xs btn-success">Bayar Sekarang</a></td>
					</tr>
					<?php } ?>
				</table>
